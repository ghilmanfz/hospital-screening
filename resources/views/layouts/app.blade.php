...
<head>
    ...
    <title>@yield('title', 'Portal Rumah Sakit') - Mayapada Hospital</title>
                ...
                extend: {
                    colors: {
                        navy: {
                            ...
                            900: '#0b2545', // Mayapada Deep Navy
                            950: '#00205b', // Deloitte Brand Navy
                        },
                        emerald: {
                            500: '#10b981',
                            600: '#059669',
                            700: '#008751', // Mayapada Green
                            800: '#065f46',
                        }
                    },
                    fontFamily: {
    ...
    <header class="bg-white border-b border-slate-100 sticky top-0 z-50 shadow-sm backdrop-blur-md bg-white/95">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            ...
            <a href="{{ route('public.home') }}" class="flex items-center space-x-3 group">
                ...
                @else
                    <div class="h-11 w-11 rounded-xl bg-gradient-mayapada flex items-center justify-center shadow-md shadow-navy-900/20 group-hover:scale-105 transition-transform">
                        <i class="fa-solid fa-hospital text-white text-lg"></i>
                    </div>
                @endif
                <div>
                    <div class="flex items-center space-x-1">
                        <span class="font-bold text-xl text-navy-900 tracking-tight">mayapada</span>
                        <span class="font-medium text-xl text-emerald-700 tracking-tight">hospital</span>
                    </div>
                    <span class="text-xs font-semibold uppercase tracking-wider text-slate-400 block -mt-1">Portal Digital</span>
                </div>
            </a>
            ...
            <div class="flex items-center space-x-4">
                @auth
                    ...
                    @endif
                    <a href="{{ route('auth.logout') }}" class="text-sm font-medium text-white bg-gradient-mayapada px-5 py-2.5 rounded-xl hover:shadow-md hover:scale-[1.02] transition-all">
                ...
                @else
                    ...
                    <a href="{{ route('auth.register') }}" class="text-sm font-medium text-white bg-gradient-mayapada px-5 py-2.5 rounded-xl hover:shadow-lg hover:shadow-navy-950/20 hover:scale-[1.02] transition-all flex items-center space-x-2">
    ...
    <footer class="bg-navy-950 text-slate-400 py-12 border-t border-navy-900 mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        @else
                            <div class="h-10 w-10 rounded-xl bg-white/10 flex items-center justify-center">
                                <i class="fa-solid fa-hospital text-white text-md"></i>
                            </div>
                        @endif
                        <span class="font-bold text-lg text-white">mayapada hospital</span>
                    </div>
                    <p class="text-sm text-slate-400 max-w-sm">
                        Menyediakan pelayanan kesehatan berstandar internasional yang mengutamakan keselamatan pasien serta didukung tenaga medis profesional dan peralatan medis mutakhir.
                    </p>
            ...
            <div class="border-t border-navy-900 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
                <p>&copy; {{ date('Y') }} Mayapada Hospital. All Rights Reserved. Clean & Modern Portal.</p>
